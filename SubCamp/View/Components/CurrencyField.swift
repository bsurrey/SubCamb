...
//  SubCamp
//
//  Created by Benjamin Surrey on 17.03.24.
//
    ...
    public var body: some View {
        ZStack {
            ...
            Text(label).layoutPriority(1)
                .multilineTextAlignment(.trailing) // Add this line to align text to the right
...
struct CurrencyInputField: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> NoCaretTextField {
        ...
        textField.textAlignment = .right // Set text alignment to right
